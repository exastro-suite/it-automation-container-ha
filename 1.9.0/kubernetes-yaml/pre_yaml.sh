...
#aft_dep_webapp_teraform_ip=xxx.xxx.xxx.xxx
#aft_dep_webapp_teraform_host=hostname
...
#sed -i s@\$\{bef_dep_webapp_teraform_host\}@$aft_dep_webapp_teraform_host@g itaha_all.yaml
#sed -i s@\$\{bef_dep_webapp_teraform_ip\}@$aft_dep_webapp_teraform_ip@g itaha_all.yaml
